   ...
   <!-- <input placeholder="Search any word.." id='myInput' onkeyup="searchFun()"/>-->
    <table id='myTable'>
        ...
        <tr class="edit_tab">
            ...
            <button id='editting_btn' onclick = " del_form.rmv_word_id.value += '<?php echo $res['id']; ?>' " class='edit_del_btn'>    
...
if(isset($_POST['update']))
{
    ...
    $update_quary = "UPDATE `products` SET `word`='$word',`word_meaning`='$word_meaning',`description`='$description',`example`='$example' WHERE id = '$word_id'";
}
?>
</html>